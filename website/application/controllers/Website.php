...
class Website extends CI_Controller {
					...
					foreach($Getsection_item_result_array as $key_item=>$item_value)
		          	{
						...
						$section_result[$value['section_name']][$key_item]['website'] = $value['website'];
	...
	public function updateenquiry(){
		if(isset($_POST)){
			...
			(section_item,website,name,state,country,description,type) values('".$_POST['section_item']."','".$_POST['currentweb']."','".$_POST['name']."','".$_POST['state']."','".$_POST['country']."','".$_POST['description']."','".$_POST['type']."')");
