	...
	function servicepopupimage_section(name,image,desc,update_id,weblink,type,src_file,web_url,img_arr_list,viewUrl)
  	{
		...
		$('#desc2_section').html('<div class="description">'+desc+'</div><input type="hidden" value="'+update_id+'" id="service_id"><br><div><a href="'+image+'" target="_blank">Click here to view</a></div><br>'+webContainer+'<br><div><a  href='+viewUrl+'#enquirynow'+' tabindex="-1"><button type="button" class="btn btn-primary" tabindex="-1">Enquiry</button></a></div>');
