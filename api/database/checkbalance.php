        ...
        $elarn_user=0;
            ...
            if($array1[0]['pck_type']==2){
                ...
                $elearn_role_id  = 2;
                 ...
                 $elarn_user = mysqli_insert_id($con);
            }
            ...
            /*Update Elaern user id to affilate user(BY mani) **/
            $query=mysqli_query($con,"update affiliateuser set elearn_user_id='".$elarn_user."'where id='".$tomake."'");
            /*********/
