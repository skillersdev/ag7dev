...
public function get_floor_list()
  ...
  public function updatefloor() {
        ...
        if (isset($model)) {
           ...
           $result=$this->db->query("update ".$this->db->dbprefix('floor_master')." set  floor_name='".$model->floor_name."',image_name='".$model->image_name."',floor_detail_banner='".$model->floor_detail_banner."',mall_id='".$model->mall_id."',username='".$model->username."',password='".$model->password."',created_date='".$model->created_date."' where id='".$model->id."'");
