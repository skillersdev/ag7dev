  ...
  editpackage(id:any)
  {
    ...
    this.CommonService.editdata(this.FetchpackageRestApiUrl,id)
        .subscribe(resultdata =>{   
          ...
          let stage_bonus_amount=JSON.parse(this.model['stage_bonus_amount']);
          let stage_upgradation_amount=JSON.parse(this.model['stage_upgradation_amount']);
          stage_bonus_amount.filter((data:any,id:any) =>{
              this.stage_of_packages.push({'id':id,'stage_bonus_amount':data.stage_bonus_amount,'stage_upgradation_amount':stage_upgradation_amount[id]['stage_upgradation_amount']});
          }); 
